...
INSERT INTO users (id, username, password, role, full_name, email, sdt) VALUES
  (1, 'admin',    'passadmin', 'admin',    'Quản trị viên',        'admin@eaut.edu.vn',    '0901111111'),
  (2, 'teacher',  'passtea',   'teacher',  'Nguyễn Đức Thiện',     'thien@eaut.edu.vn',    '0901234567'),
  (3, 'employee', 'passemp',   'employee', 'Trần Thu Hương',       'huongtt@eaut.edu.vn',  '0987654321'),
  (4, 'user',     'passuser',  'student',  'Đào Việt Quang Huy',   'quanghuy@sv.eaut.edu.vn', '0912345678'),
  (5, 'gv_lec',   'passtea',   'teacher',  'Lê Trung Thực',        'thuc@eaut.edu.vn',     '0901234568'),
  (6, 'gv_nta',   'passtea',   'teacher',  'Ngô Thảo Anh',         'anh@eaut.edu.vn',      '0901234569'),
  (7, 'gv_ltc',   'passtea',   'teacher',  'Lê Thị C',             'lec@eaut.edu.vn',      '0901234570'),
  (8, 'gv_pvk',   'passtea',   'teacher',  'Phạm Văn K',           'pvk@eaut.edu.vn',      '0901234571'),
  (9, 'gv_pvd',   'passtea',   'teacher',  'Phạm Văn D',           'pvd@eaut.edu.vn',      '0901234572'),
  (10,'gv_hmt',   'passtea',   'teacher',  'Hoàng Minh Tuấn',      'hmt@eaut.edu.vn',      '0901234573'),
  (11,'gv_nte',   'passtea',   'teacher',  'Nguyễn Thị E',         'nte@eaut.edu.vn',      '0901234574'),
  (12,'gv_lvm',   'passtea',   'teacher',  'Lê Văn M',             'lvm@eaut.edu.vn',      '0901234575'),
  (13,'hv002',    'passuser',  'student',  'Trần Thị Bích',        'bich@sv.eaut.edu.vn',  '0923456789'),
  (14,'hv003',    'passuser',  'student',  'Lê Văn Cường',         'cuong@sv.eaut.edu.vn', '0934567890'),
  (15,'hv010',    'passuser',  'student',  'Phạm Thị Dung',        'dung@sv.eaut.edu.vn',  '0945678901'),
  (16,'hv015',    'passuser',  'student',  'Hoàng Văn Em',         'em@sv.eaut.edu.vn',    '0956789012'),
  (17,'hv020',    'passuser',  'student',  'Vũ Thị Phương',        'phuong@sv.eaut.edu.vn','0967890123'),
  (18,'hv025',    'passuser',  'student',  'Nguyễn Thanh Giang',   'giang@sv.eaut.edu.vn', '0978901234'),
  (19,'hv030',    'passuser',  'student',  'Bùi Thị Hồng',         'hong@sv.eaut.edu.vn',  '0989012345'),
  (20,'nv002',    'passemp',   'employee', 'Lê Minh Đức',          'ducm@eaut.edu.vn',     '0987654322'),
  (21,'nv003',    'passemp',   'employee', 'Phạm Quỳnh Anh',       'anhpq@eaut.edu.vn',    '0987654323'),
  (22,'nv004',    'passemp',   'employee', 'Nguyễn Hoài Linh',     'linh@eaut.edu.vn',     '0987654324');
...
INSERT INTO teachers (user_id, ma_gv, hoc_vi, khoa, chuyen_nganh, tham_nien) VALUES
  (2,  'GV001', 'Tiến sĩ',     'CNTT', 'Công nghệ thông tin', 10),
  (5,  'GV002', 'Thạc sĩ',     'CNTT', 'Kỹ thuật phần mềm',   6),
  (6,  'GV003', 'Tiến sĩ',     'CNTT', 'Trí tuệ nhân tạo',    8),
  (7,  'GV004', 'Thạc sĩ',     'CNTT', 'Cơ sở dữ liệu',       7),
  (8,  'GV005', 'Thạc sĩ',     'CNTT', 'Hệ thống thông tin',  5),
  (9,  'GV006', 'Thạc sĩ',     'CNTT', 'Mạng máy tính',       6),
  (10, 'GV007', 'Tiến sĩ',     'CNTT', 'Trí tuệ nhân tạo',    9),
  (11, 'GV008', 'Phó giáo sư', 'Toán', 'Toán rời rạc',        15),
  (12, 'GV009', 'Tiến sĩ',     'Toán', 'Toán ứng dụng',       12);

INSERT INTO employees (user_id, ma_nv, chuc_vu, phong_ban, ngay_vao_lam) VALUES
  (3,  'NV001', 'Nhân viên đăng ký',  'Phòng đào tạo',  '2022-03-15'),
  (20, 'NV002', 'Nhân viên thu ngân', 'Phòng tài chính','2023-01-10'),
  (21, 'NV003', 'Nhân viên đăng ký',  'Phòng đào tạo',  '2023-06-01'),
  (22, 'NV004', 'Quản lý',            'Phòng đào tạo',  '2021-09-20');

INSERT INTO students (user_id, msv, ngaysinh, gioitinh, diachi) VALUES
  (4,  'HV2024001', '2004-03-15', 'Nam', 'Đà Nẵng'),
  (13, 'HV2024002', '2003-06-20', 'Nữ',  'Hà Nội'),
  (14, 'HV2024003', '2004-11-08', 'Nam', 'Hải Phòng'),
  (15, 'HV2024010', '2003-07-25', 'Nữ',  'Quảng Ninh'),
  (16, 'HV2024015', '2004-12-12', 'Nam', 'Nam Định'),
  (17, 'HV2024020', '2003-04-30', 'Nữ',  'Thanh Hoá'),
  (18, 'HV2024025', '2004-09-05', 'Nam', 'Ninh Bình'),
  (19, 'HV2024030', '2003-02-18', 'Nữ',  'Thái Bình');
...
INSERT INTO semesters (id, ten, nam_hoc, bat_dau, ket_thuc, trang_thai) VALUES
  ('HK2-2526', 'Học kỳ 2', '2025-2026', '2026-01-01', '2026-06-30', 'open'),
  ('HK1-2526', 'Học kỳ 1', '2025-2026', '2025-08-01', '2025-12-31', 'closed'),
  ('HK2-2425', 'Học kỳ 2', '2024-2025', '2025-01-01', '2025-06-30', 'closed'),
  ('HK1-2425', 'Học kỳ 1', '2024-2025', '2024-08-01', '2024-12-31', 'closed');


-- ===== COURSES =====
INSERT INTO courses (ma_mon, ten_mon, mo_ta) VALUES
  ('IT001', 'Lập trình Python',     'Khoá học Python cơ bản đến nâng cao'),
  ('IT002', 'Cơ sở dữ liệu',        'SQL, thiết kế database'),
  ('IT003', 'Mạng máy tính',        'TCP/IP, routing, cấu hình mạng'),
  ('IT004', 'Trí tuệ nhân tạo',     'Machine learning, deep learning'),
  ('IT005', 'Phát triển web',       'HTML, CSS, JavaScript, React'),
  ('IT006', 'Hệ điều hành',         'Linux, Windows, quản lý process'),
  ('MA001', 'Toán rời rạc',         'Logic, tập hợp, đồ thị, tổ hợp'),
  ('MA002', 'Xác suất thống kê',    'Thống kê ứng dụng'),
  ('EN001', 'Tiếng Anh chuyên ngành', 'Tiếng Anh IT trình độ B1');
